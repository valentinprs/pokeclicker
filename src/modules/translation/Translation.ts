...
export type TranslationNamespace = 'pokemon' | 'logbook' | 'settings' | 'questlines' | 'locations' | 'ui';
...
export default class Translate {
    ...
    constructor(languageSetting: Setting<Language>) {
        const namespaces: TranslationNamespace[] = ['pokemon', 'logbook', 'settings', 'questlines', 'locations', 'ui'];
